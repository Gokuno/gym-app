  ...
  return (
    <section id={id} className='min-h-screen flex flex-col gap-10'>
        <div className='bg-slate-950 py-10 flex flex-col gap-2 justify-center items-center p-4'>
            ...
            <h2 className='font-semibold text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-center'>{title[0]} <span className='uppercase text-blue-400'>{title[1]}</span> {title[2]} <span className='uppercase text-blue-400'>{title[3]}</span></h2>
        </div>
