...
export default function Hero() {
  return (
    <div className='min-h-screen flex flex-col gap-10 items-center justify-center text-center max-w-[900px] w-full mx-auto p-4'>
        ...
        <p className='text-sm md:text-base font-light'>I hereby acknowledge that I may become <span className='text-blue-400 font-medium'>unbelievably enormous</span> and accept all risks of becaming the local <span className='text-blue-400 font-medium'>mass monstrosity</span>, affected with severe body dismorphia, unable to fit through doors.</p>
